...
export interface TenantDataset {
  ...
  reportEmail: string;
  /**
   * True when this dataset is real, server-aggregated data (Supabase accounts).
   * Drives exact per-model breakdowns; the local demo leaves it undefined and
   * keeps its authored model split.
   */
  live?: boolean;
}
