// ---------------------------------------------------------------------------
// Shared domain types for the Community Analytics dashboard.
//
// The app is multi-tenant: each account owns a tenant (workspace) with its own
// connected chatbots. Analytics are computed per tenant from the chatbots the
// tenant has connected (src/lib/dataset.ts -> src/lib/mockData.ts). The seeded
// "NY Yankees" tenant reproduces the original design dataset exactly.
// ---------------------------------------------------------------------------
...
export type Nav = 'dashboard' | 'chatbots' | 'usage' | 'reports' | 'settings';
...
// ---------------------------------------------------------------------------
// Persisted account / tenant model (src/lib/store.ts, localStorage-backed).
// ---------------------------------------------------------------------------
