...
// Aggregates this tenant's real usage_events + top_questions into the exact
// TenantDataset shape the frontend already knows how to render. Headline totals
// (cost, tokens, users, messages), busiest hours, and top questions are REAL;
// the intra-period daily curve is still synthesized client-side from the totals
// (a seed is provided), which is fine for MVP.
